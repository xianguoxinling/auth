...
public class ModifyHeadPicController implements Controller
{
	@Override
			...
			HttpServletResponse response) throws Exception
	{
		...
		if(null == headPic2)
		{
			result = service.addHeadPic(userID, filePath,keyID);
		}
		else
		{
			result = service.modifyHeadPic(userID, filePath,keyID);
		}
